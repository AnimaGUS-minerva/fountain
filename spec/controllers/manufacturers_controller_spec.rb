...
RSpec.describe ManufacturersController, type: :controller do
  ...
  let(:invalid_attributes) {
    skip("no invalid attributes defined yet")
  }
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved manufacturer as @manufacturer" do
        post :create, {:manufacturer => invalid_attributes}, valid_session
        expect(assigns(:manufacturer)).to be_a_new(Manufacturer)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested manufacturer" do
        manufacturer = Manufacturer.create! valid_attributes
        put :update, {:id => manufacturer.to_param, :manufacturer => new_attributes}, valid_session
        manufacturer.reload
    ...
    context "with invalid params" do
      it "assigns the manufacturer as @manufacturer" do
        manufacturer = Manufacturer.create! valid_attributes
        put :update, {:id => manufacturer.to_param, :manufacturer => invalid_attributes}, valid_session
        expect(assigns(:manufacturer)).to eq(manufacturer)
      end
